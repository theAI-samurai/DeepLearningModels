...
DATAPATH = "/home/ankit/Downloads/DeepLearningModels/zeroshotlearning/data/zeroshot_data.pkl"
...
def train_model(model, train_data, valid_data):
    ...
    history = model.fit(x_train, y_train, validation_data = (x_valid, y_valid), verbose=2, epochs=EPOCH,batch_size=BATCH_SIZE, shuffle=True)
    print("model training is completed.")
    return history


#global train_classes
with open('/home/ankit/Downloads/DeepLearningModels/zeroshotlearning/src/train_classes.txt', 'r') as infile:
    train_classes = [str.strip(line) for line in infile]

#global zsl_classes
with open('/home/ankit/Downloads/DeepLearningModels/zeroshotlearning/src/zsl_classes.txt', 'r') as infile:
